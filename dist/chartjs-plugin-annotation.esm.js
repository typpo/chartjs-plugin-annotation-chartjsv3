...
const {isObject: isObject$1, valueOrDefault: valueOrDefault$1, defined} = ChartJsV3.helpers;
...
const {addRoundedRectPath, isArray: isArray$1, toFont, toTRBLCorners, valueOrDefault} = ChartJsV3.helpers;
